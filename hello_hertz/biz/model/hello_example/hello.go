...
type HelloService interface {
	...
	ByeMethod(ctx context.Context, request *HelloReq) (r *HelloResp, err error)
}
...
func (p *HelloServiceClient) ByeMethod(ctx context.Context, request *HelloReq) (r *HelloResp, err error) {
	var _args HelloServiceByeMethodArgs
	_args.Request = request
	var _result HelloServiceByeMethodResult
	if err = p.Client_().Call(ctx, "ByeMethod", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func NewHelloServiceProcessor(handler HelloService) *HelloServiceProcessor {
	...
	self.AddToProcessorMap("ByeMethod", &helloServiceProcessorByeMethod{handler: handler})
	return self
}
...
type helloServiceProcessorByeMethod struct {
	handler HelloService
}

func (p *helloServiceProcessorByeMethod) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := HelloServiceByeMethodArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("ByeMethod", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := HelloServiceByeMethodResult{}
	var retval *HelloResp
	if retval, err2 = p.handler.ByeMethod(ctx, args.Request); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing ByeMethod: "+err2.Error())
		oprot.WriteMessageBegin("ByeMethod", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("ByeMethod", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type HelloServiceByeMethodArgs struct {
	Request *HelloReq `thrift:"request,1"`
}

func NewHelloServiceByeMethodArgs() *HelloServiceByeMethodArgs {
	return &HelloServiceByeMethodArgs{}
}

func (p *HelloServiceByeMethodArgs) InitDefault() {
}

var HelloServiceByeMethodArgs_Request_DEFAULT *HelloReq

func (p *HelloServiceByeMethodArgs) GetRequest() (v *HelloReq) {
	if !p.IsSetRequest() {
		return HelloServiceByeMethodArgs_Request_DEFAULT
	}
	return p.Request
}

var fieldIDToName_HelloServiceByeMethodArgs = map[int16]string{
	1: "request",
}

func (p *HelloServiceByeMethodArgs) IsSetRequest() bool {
	return p.Request != nil
}

func (p *HelloServiceByeMethodArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_HelloServiceByeMethodArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *HelloServiceByeMethodArgs) ReadField1(iprot thrift.TProtocol) error {
	_field := NewHelloReq()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *HelloServiceByeMethodArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("ByeMethod_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *HelloServiceByeMethodArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *HelloServiceByeMethodArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("HelloServiceByeMethodArgs(%+v)", *p)

}

type HelloServiceByeMethodResult struct {
	Success *HelloResp `thrift:"success,0,optional"`
}

func NewHelloServiceByeMethodResult() *HelloServiceByeMethodResult {
	return &HelloServiceByeMethodResult{}
}

func (p *HelloServiceByeMethodResult) InitDefault() {
}

var HelloServiceByeMethodResult_Success_DEFAULT *HelloResp

func (p *HelloServiceByeMethodResult) GetSuccess() (v *HelloResp) {
	if !p.IsSetSuccess() {
		return HelloServiceByeMethodResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_HelloServiceByeMethodResult = map[int16]string{
	0: "success",
}

func (p *HelloServiceByeMethodResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *HelloServiceByeMethodResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_HelloServiceByeMethodResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *HelloServiceByeMethodResult) ReadField0(iprot thrift.TProtocol) error {
	_field := NewHelloResp()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *HelloServiceByeMethodResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("ByeMethod_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *HelloServiceByeMethodResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *HelloServiceByeMethodResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("HelloServiceByeMethodResult(%+v)", *p)
